...
var eventSeverity = map[string]string{
	...
	EventSCIMAuthOrgMismatch:              SeverityWarning,
	EventSCIMAuthDisabled:                 SeverityWarning,
	EventSCIMTokenCreated:                 SeverityInfo,
	EventSCIMTokenRotated:                 SeverityInfo,
	EventSCIMUserProvisioned:              SeverityInfo,
	EventSCIMUserDeprovisioned:            SeverityInfo,
	EventSCIMSoleOwnerProtected:           SeverityWarning,
	EventSCIMExemptSuppressed:             SeverityWarning,
